...
//
const BotName = 'ARIEF GANS🔰'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/ff.arief12'; // Nama Instagramlu cok
const whatsapplu = '0813-1535-2901'; // Nomor whatsapplu cok
